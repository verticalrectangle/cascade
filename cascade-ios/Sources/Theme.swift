...
final class ThemeStore: ObservableObject {
    ...
    @Published var mode: Appearance = {
        Appearance(rawValue: UserDefaults.standard.string(forKey: "cascade.theme") ?? "system") ?? .system
    }() {
        didSet { UserDefaults.standard.set(mode.rawValue, forKey: "cascade.theme") }
    }
