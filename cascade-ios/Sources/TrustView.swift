//  TrustView.swift
//  Read-only trust surface for the connected session: what the daemon tells us
//  over the authenticated stream (session id, host, model, context, phase).
        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                LazyVGrid(columns: [GridItem(.flexible(), spacing: 0), GridItem(.flexible(), spacing: 0)], spacing: 0) {
                    ...
                    SpecCell(t: t, k: "Auth", v: "JWT · bearer")
                    SpecCell(t: t, k: "Proto", v: "cascade cloud")
