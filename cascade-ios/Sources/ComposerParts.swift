...
//  cascade cloud exposes no slash commands yet; these tips only ever
...
struct ComposerTips: View {
    let t: Theme
    var hasCommands: Bool = false          // reserved for future daemon commands
