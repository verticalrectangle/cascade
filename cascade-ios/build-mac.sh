#!/bin/bash
#
# build-mac.sh — build Cascade iOS on the remote Mac from the Linux workstation.
#
...
MAC_PATH="${MAC_PATH:-/Users/alexis/dev/cascade/cascade-ios}"
SCHEME="${SCHEME:-Cascade}"
