//  CascadeActivity.swift  (shared: app + CascadeWidgets extension)
...
enum CascadeStatus: String, CaseIterable {
    ...
    static func from(phase: String, working: Bool, waiting: Bool) -> CascadeStatus {
